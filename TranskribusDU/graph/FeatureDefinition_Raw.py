...
from .Transformer_GenericMin import NodeTransformerTextEnclosed
from .Transformer_GenericMin import NodeTransformerTextLen
from .Transformer_GenericMin import NodeTransformerXYWH
from .Transformer_GenericMin import NodeTransformerNeighbors
# from .Transformer_GenericMin import EdgeBooleanAlignmentFeatures
from .Transformer_GenericMin import EdgeNumericalSelector #_noText

from .Transformer_Generic import NodeTransformerTextSentencePiece

class FeatureDefinition_RawSPM(FeatureDefinition):
...
class FeatureDefinition_RawText(FeatureDefinition):
...
class FeatureDefinition_Raw(FeatureDefinition):
