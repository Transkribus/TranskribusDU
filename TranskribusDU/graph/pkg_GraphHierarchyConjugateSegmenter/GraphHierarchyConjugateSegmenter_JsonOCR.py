...
class GraphHierarchyConjugateSegmenter_jsonOCR(GraphHierarchyConjugateSegmenter, Graph_JsonOCR):
    ...
    def __init__(self, lNode = [], lEdge = [], sOuputXmlAttribute=None):
        GraphHierarchyConjugateSegmenter.__init__(self, sOuputXmlAttribute=sOuputXmlAttribute)
        Graph_JsonOCR.__init__(self, lNode, lEdge)
   
    def addClusterToDoc(self, lvl, lCluster, sAlgo=None):
        # nothing we can do here
        # the clusters are in self.lCluster
        # Graph_DOM knows how to export them in a DOM
        pass
