...
from .Transformer_Generic import NodeTransformerXYWH_vPeri
...
from .Transformer_Generic import EdgeNumericalSelector_noText_vPeri
...
"""
Features that seem better on MENUS usecase:
- better and richer geometrical features
- no Quantilization (in hope of limiting the distortion between related geometrical features)
JLM Autumn 2020
"""
class FeatureDefinition_Generic_vPeri(FeatureDefinition):
...
#                                                                                   , dtype=Feat_dtype)),
                                    ...
                                    , ("xywh", NodeTransformerXYWH_vPeri()
                                        )
                                    , ("neighbors", Pipeline([
                                                         ('selector', NodeTransformerNeighbors()),
                                                         #v1 ('neighbors', StandardScaler(copy=False, with_mean=True, with_std=True))  #use in-place scaling
...
#                                         )
#                                     , 
                                        ("numerical", EdgeNumericalSelector_noText_vPeri())
                        ]
