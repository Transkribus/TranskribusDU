...
class DU_ABPTableRG3(DU_CRF_Task):
    """
    ...
    def __init__(self, sModelName, sModelDir, 
        ...
        DU_ABPTableRG3.iGridVisibility  = iGridVisibility
        DU_ABPTableRG3.iBlockVisibility = iBlockVisibility
...
def main(sModelDir, sModelName, options):
    doer = DU_ABPTableRG3(sModelName, sModelDir, 
