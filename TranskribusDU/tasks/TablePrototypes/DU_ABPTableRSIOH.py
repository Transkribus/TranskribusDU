...
"""
    Example DU task for ABP Table: SIOH labels
...
class NodeType_BIESO_to_SIOH(NodeType_PageXml_type_woText):
    """
...
#             print( len(lIgnoredLabels)   , lIgnoredLabels)
        ...
        # ROW
        ntR = NodeType_BIESO_to_SIOH("row"
                              , lLabelsSIOH_R
                              , None
